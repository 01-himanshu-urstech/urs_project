...
export default function IntroSection() {
  return (
    <>
      {/* Vision Section */}
      <div className="mt-12 sm:mt-16 lg:mt-20 grid gap-8 sm:gap-10 lg:gap-12 xl:gap-16 grid-cols-1 md:grid-cols-3 items-center w-full">
        ...
        <motion.div
          ...
          className="md:col-span-1 rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg sm:shadow-xl lg:shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] max-w-xs mx-auto"
        >
          <Image
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="md:col-span-2 space-y-4 sm:space-y-5 lg:space-y-6"
        >
